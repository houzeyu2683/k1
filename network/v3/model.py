...
class x2(nn.Module):
    ...
    def __init__(self):
        ...
        layer = dict()
        layer['e01'] = nn.Embedding(352336, constant.embedding)
...
class x3(nn.Module):
    ...
    def __init__(self):
        ...
        layer['p01'] = nn.Embedding(240, constant.embedding)
        layer['p02'] = nn.Embedding(240, constant.embedding)
        layer['p03'] = nn.Embedding(240, constant.embedding)
        layer['p04'] = nn.Embedding(240, constant.embedding)
        layer['p05'] = nn.Embedding(240, constant.embedding)
        layer['p06'] = nn.Embedding(240, constant.embedding)
        layer['p07'] = nn.Embedding(240, constant.embedding)
        layer['p08'] = nn.Embedding(240, constant.embedding)
        layer['p09'] = nn.Embedding(240, constant.embedding)
        layer['p10'] = nn.Embedding(240, constant.embedding)
        layer['p11'] = nn.Embedding(240, constant.embedding)
        layer['p12'] = nn.Embedding(240, constant.embedding)
        layer['p13'] = nn.Embedding(240, constant.embedding)
        layer['p14'] = nn.Embedding(240, constant.embedding)
        layer['p15'] = nn.Embedding(240, constant.embedding)
        layer['p16'] = nn.Embedding(240, constant.embedding)
        layer['p17'] = nn.Embedding(240, constant.embedding)
        layer['p18'] = nn.Embedding(240, constant.embedding)
        layer['p19'] = nn.Embedding(240, constant.embedding)
        layer['p20'] = nn.Embedding(240, constant.embedding)
        layer['p21'] = nn.Embedding(240, constant.embedding)
        layer['p22'] = nn.Embedding(240, constant.embedding)
        layer['p23'] = nn.Embedding(240, constant.embedding)
        layer['p24'] = nn.Embedding(240, constant.embedding)
        layer['p25'] = nn.Embedding(240, 512)
